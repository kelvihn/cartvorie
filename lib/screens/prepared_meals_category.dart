...
class PreparedMealsCategory extends StatefulWidget {
  @override
  _PreparedMealsCategoryState createState() => _PreparedMealsCategoryState();
}

class _PreparedMealsCategoryState extends State<PreparedMealsCategory> {
  @override
