...
import 'package:cartvorie/screens/buyer/contact_admin_message.dart';
import 'package:cartvorie/screens/buyer/chat_technical.dart';
...
class _ContactAdminState extends State<ContactAdmin> {
        ...
        child: Scaffold(
            ...
            body: SingleChildScrollView(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 20),
                messageBox('assets/images/sophia.jpg', 'Technical \nSupport',
                    '2', 'Online'),
              ],
            ))));
  }
    ...
    return GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (_) => MessageAdmin()));
        },
        child: Container(
            height: 30,
            width: 100,
  ...
  Widget messageBox(String image, String name, String number, String status) {
    return GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (_) => ChatTechnical()));
        },
        child: Container(
            height: 100,
