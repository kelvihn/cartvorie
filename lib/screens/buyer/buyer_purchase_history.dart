...
import 'package:cartvorie/screens/buyer/buyer_purchase_details.dart';

class BuyerPurchaseHistory extends StatefulWidget {
  @override
  _BuyerPurchaseHistoryState createState() => _BuyerPurchaseHistoryState();
}

class _BuyerPurchaseHistoryState extends State<BuyerPurchaseHistory> {
                        ...
                        GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (_) => BuyerPurchaseDetails()));
                            },
