...
import 'package:cartvorie/screens/checkout_two.dart';
import 'package:flutter_icons/flutter_icons.dart';
import 'package:simple_tooltip/simple_tooltip.dart';

class PaymentDetailsGrocery extends StatefulWidget {
  @override
  _PaymentDetailsGroceryState createState() => _PaymentDetailsGroceryState();
}

class _PaymentDetailsGroceryState extends State<PaymentDetailsGrocery> {
  bool isShown = true;
  @override
                ...
                GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (_) => CheckoutTwo()));
                    },
                  ...
                  children: <Widget>[
                    Column(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(height: 3),
                          Text(
                            "(Service fee helps support the \nmaintenance of the app,\nweb and support staff.)",
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 12,
                    ...
                    Row(
                      children: [
                        ...
                        SimpleTooltip(
                          ...
                          content: Text(
                            "(Service fee helps support the maintenance of the app, web and support staff.)",
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 12,
                              decoration: TextDecoration.none,
