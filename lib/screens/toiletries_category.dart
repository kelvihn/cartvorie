...
class ToiletriesCategory extends StatefulWidget {
  @override
  _ToiletriesCategoryState createState() => _ToiletriesCategoryState();
}

class _ToiletriesCategoryState extends State<ToiletriesCategory> {
  @override
      ...
      Container(
          ...
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('assets/images/toiletries.jpg'),
                  fit: BoxFit.cover))),
      Container(
        height: 190,
        width: MediaQuery.of(context).size.width,
